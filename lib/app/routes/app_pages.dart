...
import '../modules/Add Item/bindings/add_item_binding.dart';
import '../modules/Add Item/views/add_item_view.dart';
...
import '../modules/detailed_admin_product/bindings/detailed_admin_product_binding.dart';
import '../modules/detailed_admin_product/views/detailed_admin_product_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.DETAILED_ADMIN_PRODUCT,
      page: () => const DetailedAdminProductView(),
      binding: DetailedAdminProductBinding(),
    ),
  ];
}
