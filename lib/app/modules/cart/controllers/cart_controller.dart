...
class CartController extends GetxController {
  ...
  // }
  void mapCart() {
    var cartJson = MemoryManagement.getMyCart() ?? '[]';
    var cart = jsonDecode(cartJson) as List<dynamic>;

    this.cart = cart.map((e) {
      var product = Product.fromJson(e['product'] ?? {});
      var quantity =
          e['quantity'] as int? ?? 0; // Default to 0 if quantity is null
